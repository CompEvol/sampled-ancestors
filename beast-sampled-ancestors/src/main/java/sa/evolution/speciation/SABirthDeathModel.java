...
//        if (rhoProbability.get() != null ) {/home/rbou019/workspace/sampled-ancestors/dist/SA.v2.1.0.zip
        	...
        	if (operators != null) {
        		for (Operator op : operators) {
        			...
        			if (op.getClass().isAssignableFrom(TipDatesRandomWalker.class) || 
        				...
        				// scale operators on Trees sho/home/rbou019/workspace/sampled-ancestors/dist/SA.v2.1.0.zipuld be replaced with SAScaleOperator
